    ...
    <section className="mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 py-16 lg:px-10">
      ...
      <Container>
        <div className="rounded-[2.2rem] border border-bark/10 bg-white px-7 py-8 shadow-card lg:px-9">
          ...
          <h2 className="mt-3 text-3xl font-semibold text-ink sm:text-4xl">Choose the next step that matches the story.</h2>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Button href={localePath('/about/contact', 'en')} variant="tertiary">
              Contact VSF
            </Button>
          </div>
        </div>
